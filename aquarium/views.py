...
def index():
    ...
    return render_template('index.html', data='imapeanutbutter')
...
def section(sec, path):
    ...
    try:
        ...
        # mod = __import__('aquarium.sections.' + sec, globals(), locals(), ['index'], -1)
        # mod = exec 'import sections.' + sec
        # module = __import__('sections')
        # exec imp
        # print dir(mod)
